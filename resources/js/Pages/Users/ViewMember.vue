...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Bekijk lid</h2>
        </template>
        <form>
        <div class="py-8">
                        ...
                        <div class="flex gap-6 flex-wrap lg:flex-nowrap">
                            <div class="w-full lg:w-1/2 inline-block">
                                ...
                                <TextInput
                                    ...
                                    autofocus
                                    autocomplete="name"
                                    model-value="Voornaam"/>
                            </div>
                            <div class="w-full lg:w-1/2 inline-block">
                                <InputLabel for="lastname" value="Achternaam" />
            ...
            <div class="pb-8">
                <div class="mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                        <h2 class="mb-2 text-md font-semibold uppercase">Persoons gegevens</h2>
                        <hr class="mb-4">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                <PrimaryButton>Gebruiker toevoegen</PrimaryButton>
                            </div>
                        </div>
        ...
        <div class="pb-8">
            <div class="mx-auto px-2 sm:px-6 lg:px-8">
                <div class="bg-white overflow-scroll shadow-sm rounded-md sm:rounded-lg border border-gray-200">
                    <div class="p-6">
                        <h2 class="mb-2 text-md uppercase font-semibold">Gekoppelde aanvragen</h2>
                        <hr class="mb-4">
